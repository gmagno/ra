...
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'EDT', (0.4, 1.4))
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'T30', (0.4, 1.4))
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'C80', (0, 12))
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'D50', (40, 100))
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'Ts', (30, 90))
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'G', (16, 24))
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'LF', (0, 40))
plot_vs_freq(sou, participant, js, jrec, 'TREM', 'LFC', (0, 50))
